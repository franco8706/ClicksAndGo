...
((SELECT id FROM retailers WHERE slug='lenovo_ar' AND country_code='AR'),
 ...
 'https://p2-ofp.static.pub/fes/cms/2024/01/15/legion-pro-7i-gen9-onyx-grey-gallery-1.png',
...
((SELECT id FROM retailers WHERE slug='lenovo_ar' AND country_code='AR'),
 ...
 'https://p2-ofp.static.pub/fes/cms/2024/01/15/ideapad-slim-5-gen9-abyss-blue-gallery-1.png',
...
((SELECT id FROM retailers WHERE slug='hp_ar' AND country_code='AR'),
 ...
 'https://ssl-product-images.www8-hp.com/digmedialib/prodimg/lookups/c08243963.png',
...
((SELECT id FROM retailers WHERE slug='hp_ar' AND country_code='AR'),
 ...
 'https://ssl-product-images.www8-hp.com/digmedialib/prodimg/lookups/c08301234.png',
...
((SELECT id FROM retailers WHERE slug='dell_ar' AND country_code='AR'),
 ...
 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/xps-notebooks/xps-13-9340/media-gallery/xps-13-9340-black-gallery-1.psd?fmt=png-alpha&scl=1&hei=402&wid=402',
...
((SELECT id FROM retailers WHERE slug='dell_ar' AND country_code='AR'),
 ...
 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/vostro-notebooks/vostro-15-3525/media-gallery/vostro-15-3525-black-gallery-1.psd?fmt=png-alpha&scl=1&hei=402&wid=402',
...
((SELECT id FROM retailers WHERE slug='asus_ar' AND country_code='AR'),
 ...
 'https://dlcdnwebimgs.asus.com/gain/03BCBA7B-BF8B-44C7-A815-A4D681D35D93/w800/fwebp',
...
((SELECT id FROM retailers WHERE slug='asus_ar' AND country_code='AR'),
 ...
 'https://dlcdnwebimgs.asus.com/gain/C9F72E3C-1B08-4462-8D04-4F7C00BB1D5F/w800/fwebp',
...
((SELECT id FROM retailers WHERE slug='dell_us' AND country_code='US'),
 ...
 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/xps-notebooks/xps-15-9530/media-gallery/black/notebook-xps-15-9530-t-black-gallery-1.psd?fmt=png-alpha&scl=1&hei=402&wid=402',
...
((SELECT id FROM retailers WHERE slug='hp_us' AND country_code='US'),
 ...
 'https://ssl-product-images.www8-hp.com/digmedialib/prodimg/lookups/c08401234.png',
...
((SELECT id FROM retailers WHERE slug='lenovo_us' AND country_code='US'),
 ...
 'https://p3-ofp.static.pub/fes/cms/2023/04/20/thinkpad-x1-carbon-gen11-black-gallery-1.png',
...
((SELECT id FROM retailers WHERE slug='asus_us' AND country_code='US'),
 ...
 'https://dlcdnwebimgs.asus.com/gain/8E6B4E87-9F25-4D5A-B28E-DEA1DBDA74AC/w800/fwebp',
...
((SELECT id FROM retailers WHERE slug='razer_us' AND country_code='US'),
 ...
 'https://hybrismediaprod.blob.core.windows.net/sys-master-phoenix-images-h-folder/h8a/hf5/9282783092766/blade-15-qhd-300hz-rz09-0485-back-1500x1000.png',
...
((SELECT id FROM retailers WHERE slug='acer_us' AND country_code='US'),
 ...
 'https://static.acer.com/up/Resource/Acer/Laptops/Predator_Helios_300/PH315-55/20220121/PH315-55-736F-01.jpg',
...
((SELECT id FROM retailers WHERE slug='lenovo_us' AND country_code='US'),
 ...
 'https://p3-ofp.static.pub/fes/cms/2022/09/08/ideapad-gaming-3-gen7-onyx-grey-gallery-1.png',
...
((SELECT id FROM retailers WHERE slug='hp_us' AND country_code='US'),
 ...
 'https://ssl-product-images.www8-hp.com/digmedialib/prodimg/lookups/c08156321.png',
...
((SELECT id FROM retailers WHERE slug='hp_es' AND country_code='ES'),
 ...
 'https://ssl-product-images.www8-hp.com/digmedialib/prodimg/lookups/c08298765.png',
...
((SELECT id FROM retailers WHERE slug='lenovo_es' AND country_code='ES'),
 ...
 'https://p2-ofp.static.pub/fes/cms/2024/01/15/ideapad-5-pro-14ahp9-cloud-grey-gallery-1.png',
...
((SELECT id FROM retailers WHERE slug='dell_es' AND country_code='ES'),
 ...
 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/latitude-notebooks/latitude-5540/media-gallery/latitude-5540-nt-gallery-1.psd?fmt=png-alpha&scl=1&hei=402&wid=402',
...
((SELECT id FROM retailers WHERE slug='asus_es' AND country_code='ES'),
 ...
 'https://dlcdnwebimgs.asus.com/gain/18C0A4B5-8E9D-4E1D-A8C3-E2D0E28C3F1A/w800/fwebp',
...
((SELECT id FROM retailers WHERE slug='hp_es' AND country_code='ES'),
 ...
 'https://ssl-product-images.www8-hp.com/digmedialib/prodimg/lookups/c08270541.png',
...
((SELECT id FROM retailers WHERE slug='lenovo_es' AND country_code='ES'),
 ...
 'https://p3-ofp.static.pub/fes/cms/2023/04/28/thinkpad-e14-gen5-black-gallery-1.png',
...
((SELECT id FROM retailers WHERE slug='dell_es' AND country_code='ES'),
 ...
 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/xps-notebooks/xps-13-plus-9320/media-gallery/xps-13-plus-9320-black-gallery-1.psd?fmt=png-alpha&scl=1&hei=402&wid=402',
...
((SELECT id FROM retailers WHERE slug='lenovo_mx' AND country_code='MX'),
 ...
 'https://p2-ofp.static.pub/fes/cms/2022/09/08/ideapad-3-gen7-arctic-grey-gallery-1.png',
...
((SELECT id FROM retailers WHERE slug='dell_mx' AND country_code='MX'),
 ...
 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/inspiron-notebooks/inspiron-14-5430/media-gallery/blue/notebook-inspiron-14-5430-blue-gallery-1.psd?fmt=png-alpha&scl=1&hei=402&wid=402',
...
((SELECT id FROM retailers WHERE slug='hp_mx' AND country_code='MX'),
 ...
 'https://ssl-product-images.www8-hp.com/digmedialib/prodimg/lookups/c08156789.png',
...
((SELECT id FROM retailers WHERE slug='lenovo_mx' AND country_code='MX'),
 ...
 'https://p3-ofp.static.pub/fes/cms/2022/06/14/yoga-slim-7-pro-14ahp9-cloud-grey-gallery-1.png',
...
((SELECT id FROM retailers WHERE slug='dell_mx' AND country_code='MX'),
 ...
 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/vostro-notebooks/vostro-14-3430/media-gallery/vostro-14-3430-black-gallery-1.psd?fmt=png-alpha&scl=1&hei=402&wid=402',
...
((SELECT id FROM retailers WHERE slug='dell_br' AND country_code='BR'),
 ...
 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/inspiron-notebooks/inspiron-15-3511/media-gallery/black/notebook-inspiron-15-3511-black-gallery-1.psd?fmt=png-alpha&scl=1&hei=402&wid=402',
...
((SELECT id FROM retailers WHERE slug='lenovo_br' AND country_code='BR'),
 ...
 'https://p2-ofp.static.pub/fes/cms/2022/09/08/ideapad-3i-gen7-arctic-grey-gallery-1.png',
...
((SELECT id FROM retailers WHERE slug='acer_br' AND country_code='BR'),
 ...
 'https://static.acer.com/up/Resource/Acer/Laptops/Aspire_5/A515-57/20220121/A515-57-01.jpg',
...
((SELECT id FROM retailers WHERE slug='lenovo_br' AND country_code='BR'),
 ...
 'https://p2-ofp.static.pub/fes/cms/2024/01/15/loq-15aph8-storm-grey-gallery-1.png',
